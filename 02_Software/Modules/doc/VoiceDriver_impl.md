...
| 0x03 | `brightness_up`   | 亮度+    | "调亮"/"把灯调亮"/"调高亮度"/亮点  |
| 0x04 | `brightness_down` | 亮度-    | "调暗"/"把灯调暗"/"调低亮度"/"暗点"        |
| 0x05 | `light_auto`      | 自动模式 | "自适应灯光"/"灯光自适应"/"自动亮暗"/"自动模式" |
| 0x06 | `volume_up`       | 音量+    | "调大音量"/"调高音量"/"音量调大"/"大声点"/"听不清" |
| 0x07 | `volume_down`     | 音量-    | "调小音量"/"调低音量"/"音量调小"/"小声点"   |
| 0x08 | `alarm_cancel`    | 取消报警 | "取消报警"/"解除报警"/"关闭报警"/"报警取消"  |
| 0x09 | `alarm_sos`       | SOS 报警 | **"请求救助"/"请求支援"/"请求救援"/"救命"** |
| 0x0A | `alarm_stealth`   | 静默报警 | "悄悄报警"/"后台报警"/"静默报警"/"偷偷报警" |
| 0x0B | `power_save`      | 省电模式 | "开启省电模式"/"打开省电模式"/"节能模式"     |
| 0x0C | `power_normal`    | 正常模式 | "正常模式"/"开启正常模式"/"打开正常模式"/"标准模式"/"火力全开" |
| 0x0D | `power_emergency` | 紧急省电 | "紧急省电"/"打开紧急省电"/"开启紧急省电"/"超级省电" |
...
| 0x12 | `query_location` | 查询位置 | "查询位置"/"经纬度多少"/"当前位置"/"我在哪"/"这是哪" |
| 0x13 | `query_battery` | 查询电量 | "查询电量"/"当前电量"/"电量多少"/"还有多少电" |
...
| 0x19 | `light_blink` | PWM灯光闪烁 | "闪烁"/"灯光闪烁"/"跳舞"           |
